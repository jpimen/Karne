...
class _WorkoutLogScreenState extends State<WorkoutLogScreen> {
    ...
    return Scaffold(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Focus: Anterior Chain & Volume Accumulation',
                style: TextStyle(
                  color: Colors.grey,
                  fontSize: 14,
                ),
      ...
      bottomNavigationBar: Theme(
        ...
        child: BottomNavigationBar(
          ...
          unselectedLabelStyle: const TextStyle(fontWeight: FontWeight.normal, fontSize: 10, letterSpacing: 1.2),
          items: const [
            BottomNavigationBarItem(icon: Icon(Icons.fitness_center, size: 24), label: 'SESSIONS'),
            BottomNavigationBarItem(icon: Icon(Icons.history, size: 24), label: 'HISTORY'),
            BottomNavigationBarItem(icon: Icon(Icons.show_chart, size: 24), label: 'METRICS'),
  ...
  Widget _buildVolumeCard(String title, double value, String unit) {
    ...
    final formattedValue = value == value.toInt() 
        ...
        : value.toString().replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+\.)'), (Match m) => '${m[1]},');
...
class ChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Draw a smooth bezier curve resembling the chart in the image
    path.cubicTo(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            ...
            child: Text(
              widget.rpe,
              style: const TextStyle(color: Color(0xFFD4A017), fontWeight: FontWeight.w900, fontSize: 12),
            ),
          ),
          Expanded(
            flex: 1,
          ...
          Expanded(
            flex: 1,
            child: Icon(Icons.notes, color: Colors.grey[700], size: 16),
          ),
        ],
      ),
    );
